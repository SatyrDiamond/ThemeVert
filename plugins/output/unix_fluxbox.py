...
class output_plug(plugins.base):
	...
	def parse(self, theme_obj, themeverter_intent):
		...
		def do_color_dual(name, control, colloc):
			...
			if color_fx=='gradent':
				...
				do_color(name+'.color', control, colloc)
				return True
			return False

		# window
		do_color_dual('window.button.unfocus', 'titlebar_button', 'main:control_bg')
		do_color_dual('window.button.focus', 'titlebar_button', 'hover:control_bg')
		do_color_dual('window.button.pressed', 'titlebar_button', 'pressed:control_bg')
		do_color('window.button.unfocus.picColor', 'titlebar_button', 'main:control_fg')
		do_color('window.button.focus.picColor', 'titlebar_button', 'hover:control_fg')
		do_color('window.button.pressed.picColor', 'titlebar_button', 'pressed:control_fg')
		do_color_dual('window.grip.focus', 'titlebar', 'main:control_bg')
		do_color_dual('window.grip.unfocus', 'titlebar', 'main:control_bg')
		do_color_dual('window.handle.focus', 'titlebar', 'main:control_bg')
		do_color_dual('window.handle.unfocus', 'titlebar', 'main:control_bg')
		do_color_dual('window.label.focus', 'titlebar', 'main:control_bg')
		do_color('window.label.focus.textColor', 'titlebar', 'main:control_fg')
		do_color_dual('window.label.unfocus', 'titlebar', 'main:control_bg')
		do_color('window.label.unfocus.textColor', 'titlebar', 'inactive:control_fg')
		do_color_dual('window.title.focus', 'titlebar', 'main:control_bg')
		do_color_dual('window.title.unfocus', 'titlebar', 'main:control_bg')
		...
		# menu.frame
		do_color_dual('menu.frame', 'menu', 'main:control_bg')
		...
		do_color_dual('*button.pressed', None, 'pressed:control_bg')
		do_color_dual('*button.pressed.picColor', None, 'pressed:control_fg')
